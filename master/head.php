      ...
      <tr>
        <td colspan="2" id="menu">
          ...
          <div class="menu-right">
            <?php echo ucfirst($_SESSION['log_role']); ?>  
        ...
        <td id="pane">
          <ul>
           ...
           <?php if($_SESSION['log_role'] == "admin"){ ?>
             ...
             <li><a href="lab_bookings.php">Lab bookings</a></li>
           ...
           <?php if($_SESSION['log_role'] == "patient"){  ?>
            <li><a href="dashboard.php">Dashboard</a></li>
            <li><a href="bookings.php">My Appointments</a></li>
            <li><a href="lab_bookings.php">Lab tests</a></li>
